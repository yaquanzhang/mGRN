...
print(gpu_index)
import numpy as np
import NN_main_mimic3_ihm as NN_main
...
def single_model_validation(model_dir, model_param_dict, test_data_dir, input_size_list_raw,
    ...
    test_data = NN_main.CustomDataset(test_data_dir, batch_size, input_size_list_raw, device, shuffle = False)
...
if __name__ == '__main__':
    ...
    single_model_validation(pretrained_model_path, model_param_dict, test_data_dir,
                            input_size_list_raw, batch_size, n_resample)